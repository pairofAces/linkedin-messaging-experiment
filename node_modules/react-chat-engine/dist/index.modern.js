...
var Socket = function Socket(props) {
  ...
  function handleEvent(event) {
    ...
    if (eventJSON.action === 'login_error') {
      ...
      newTypingCounter = _extends({}, newTypingCounter, (_extends3 = {}, _extends3[_id3] = _extends({}, newTypingCounter[_id3], (_extends2 = {}, _extends2[person] = Date.now() + 2000, _extends2)), _extends3));
...
var ChatList = function ChatList(props) {
  ...
  }, props.renderNewChatForm ? props.renderNewChatForm(props) : /*#__PURE__*/React.createElement(NewChatForm, null), renderChats(chatList), hasMoreChats && chatList.length > 0 && /*#__PURE__*/React.createElement(ChatLoader, {
...
var Typers = function Typers(props) {
  ...
  return Object.keys(typers).map(function (username, index) {
